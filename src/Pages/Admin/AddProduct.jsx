...
function AddProduct() {
    ...
    const productDetails = useSelector(state => state.adminProduct.addAdminProduct)
...
const handleImageDelete = (index) => {
    ...
    const AddProducts = async () => {
        try {
            ...
            // const { data } = await api.post(`/products`, formData, token);
                            ...
                            <div className="space-y-12">
                                <div className="">
                                    <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
                                        ...
                                        {/* {productId ? "" : <div className="flex flex-col gap-3">
                                            <label className="block text-sm font-medium leading-6 text-gray-900">
                                                Images
                                            </label>
                                            <div className="grid grid-cols-3 gap-4">
...

                                {
                                    productId
                                        ? <button
                                            type="submit"
                                            onClick={handlerEdit}
                                            // disabled={!productName || !subprice || !price || !categories }
